...
The forecasthistogram package contains functions to handle and study subjective probabilities ( 'forecast histograms') collected in several economic surveys. The package accompanies the paper 'Quantifying subjective uncertainty in survey expectations' by Fabian Krüger and Lora Pavlova (2022), available at <https://econpapers.wiwi.kit.edu/downloads/KITe_WP_139.pdf>. 
